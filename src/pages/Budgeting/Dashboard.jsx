    ...
    <AnimatedPage>
      <div className="text-white">
        ...
        <nav className="mb-6 flex justify-start gap-4 border-b border-gray-700 pb-3">
          ...
          <Link to="/budgeting/charts" className="text-sm text-gray-300 hover:text-white border-b-2 border-transparent hover:border-sky-500 px-2 pb-1 transition-colors">Charts</Link>
        </nav>
